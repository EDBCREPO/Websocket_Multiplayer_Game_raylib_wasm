...
public:
    ...
    /*----*/ vr_t() noexcept : global_t(), obj( new NODE() ){
        ...
        obj->device.lensSeparationDistance  = 0.05f;     // Lens separation distance in meters
        obj->device.interpupillaryDistance  = 0.05f;     // IPD (distance between pupils) in meters
