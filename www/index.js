...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(23, 0, 1, title);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 0, 1, socketId);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 0, 1, socketId, readyState);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(27, 0, 1, createAttributes);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(28, 0, 1, socketId, binaryData, dataLength);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(29, 0, 1, socketId, userData, callbackFunc, thread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 0, 1, socketId, userData, callbackFunc, thread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(31, 0, 1, socketId, userData, callbackFunc, thread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(34, 0, 1, fd, offset, whence, newOffset);
...
var ASM_CONSTS = {
  122340: ($0, $1) => { let data = Date.now() + ""; stringToUTF8( data, $0, $1 ); return data.length; },  
 122422: () => { if (document.fullscreenElement) return 1; },  
 122468: () => { return document.getElementById('canvas').width; },  
 122520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122588: () => { document.exitFullscreen(); },  
 122615: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 122688: () => { if (document.fullscreenElement) return 1; },  
 122734: () => { return document.getElementById('canvas').width; },  
 122786: () => { return screen.width; },  
 122811: () => { document.exitFullscreen(); },  
 122838: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 122971: () => { return window.innerWidth; },  
 122997: () => { return window.innerHeight; },  
 123024: () => { if (document.fullscreenElement) return 1; },  
 123070: () => { return document.getElementById('canvas').width; },  
 123122: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123190: () => { if (document.fullscreenElement) return 1; },  
 123236: () => { return document.getElementById('canvas').width; },  
 123288: () => { return screen.width; },  
 123313: () => { return window.innerWidth; },  
 123339: () => { return window.innerHeight; },  
 123366: () => { if (document.fullscreenElement) return 1; },  
 123412: () => { return document.getElementById('canvas').width; },  
 123464: () => { return screen.width; },  
 123489: () => { document.exitFullscreen(); },  
 123516: () => { if (document.fullscreenElement) return 1; },  
 123562: () => { return document.getElementById('canvas').width; },  
 123614: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123682: () => { document.exitFullscreen(); },  
 123709: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 123767: () => { return screen.width; },  
 123792: () => { return screen.height; },  
 123818: () => { return window.screenX; },  
 123845: () => { return window.screenY; },  
 123872: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 123925: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 123996: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 124053: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 124309: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 124380: () => { if (document.fullscreenElement) return 1; },  
 124426: () => { return window.innerWidth; },  
 124452: () => { return window.innerHeight; },  
 124479: () => { if (document.pointerLockElement) return 1; }
};
